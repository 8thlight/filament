(ns com.eighthlight.filament.inplace-field-spec
  (:require-macros [hiccup.core :as h]
                   [speclj.core :refer [describe context it should= with before around should-contain should-not-contain stub with-stubs should-have-invoked should-not-have-invoked]])
